...
<i class="fa fa-fw fa-briefcase"></i> User Management
...
<li>
<a href="index.php?view_manufacturers"> View Users </a>
</li>
...
<a href="#" data-toggle="collapse" data-target="#sellers"><!-- anchor Starts -->

<i class="fa fa-fw fa-users"></i> Seller Management

<i class="fa fa-fw fa-caret-down"></i>

</a><!-- anchor Ends -->

<ul id="sellers" class="collapse"><!-- ul collapse Starts -->

<li>
<a href="index.php?seller_approval"> Sellers Approval </a>
</li>
<li>
<a href="index.php?seller_rejected"> Rejected</a>
</li>
