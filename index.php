...
if ($row_admin) {
    $admin_id = $row_admin['admin_id'] ?? 'N/A';
    $admin_name = $row_admin['admin_name'] ?? 'N/A';
    $admin_email = $row_admin['admin_email'] ?? 'N/A';
    $admin_image = $row_admin['admin_image'] ?? 'default.png';
    $admin_country = $row_admin['admin_country'] ?? 'N/A';
    $admin_job = $row_admin['admin_job'] ?? 'N/A';
    $admin_contact = $row_admin['admin_contact'] ?? 'N/A';
    $admin_about = $row_admin['admin_about'] ?? 'N/A';
} else {
    echo "<p>Error: No admin found!</p>";
}
...
if(isset($_GET['seller_approval'])){

include("seller_approval.php");
